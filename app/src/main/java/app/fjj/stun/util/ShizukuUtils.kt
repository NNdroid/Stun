...
object ShizukuUtils {
    ...
    fun addSelfToBatteryWhitelist(packageName: String) {
        ...
        // Doze 模式 (deviceidle) 是从 Android 6.0 (API 23 / M) 引入的
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            app.fjj.stun.repo.StunLogger.i("ShizukuUtils", "系统版本低于 Android 6.0，无需添加电池白名单")
        }
    }
    ...
    fun setStandbyBucketActive(packageName: String) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            ...
            app.fjj.stun.repo.StunLogger.i("ShizukuUtils", "系统版本低于 Android 9.0，无需设置活跃桶")
        }
    }
